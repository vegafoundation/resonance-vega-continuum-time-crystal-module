...
\title{VEGA CONTINUUM TIME CRYSTAL MODULE: Kavramsal Bir Çerçeve}
...
\begin{abstract}
Bu çalışma, VEGA CONTINUUM TIME CRYSTAL MODULE'i Resonance Data ve QIRC paradigması içinde yeni bir kavramsal çerçeve olarak tanıtmaktadır.
